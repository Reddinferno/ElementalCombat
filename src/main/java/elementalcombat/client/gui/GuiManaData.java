package elementalcombat.client.gui;
...
public class GuiManaData extends Gui
{
	private Minecraft mc;

	public GuiManaData(Minecraft mc) {
		super();
		this.mc = mc;
	}
	...
	{
//		if (mc.thePlayer.getCurrentEquippedItem() == ModWeapons.fireMaterial.)
		...
		int xPos = 2;
		int yPos = 2;
		this.mc.getTextureManager().bindTexture(ModTextureLocation.guiMana);
		...
		int manabarwidth = (int)(((float) props.getCurrentMana() / props.getMaxMana()) * 99);
